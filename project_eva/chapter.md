...
To be able to test and simulate the two-way OSC communication i created several processing dummies, which turned out to be very useful for software tests without the full setup. (A: dummy to print out received message, or oscdump. B: dummy to send tracking parameters. C: dummy to simulate incoming tracking data)


#### split-up message blocks and framerate differences
