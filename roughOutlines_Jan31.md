...
Intent: Get comfortable the update/draw, background and 'foregrounds'

Project: Drawing a simple shapes at the mouse position
...
Intent: Explain ofColor and ways to explore colors procedurally (using recursion). Also, parameter searching.

Project: Explore the HSB way of thinking by making color compositions
...
Example images: hue, saturation, brightness
...
Extension: Documenting your work (part 1)
...
Intent: Explain power of moving coordinate system

Project: Trippy animated spiralling rectangles
...
Intent: Finish off 2D graphics using curves, beziers, and custom shape

Project: Not yet sure what will go here...
...
Extension: Documenting your work (part 2)
...
Intent: Jump into meshes, cameras, and thinking about ways to generate meshes

Project: I could attempt to shorten up the generative mesh tutorial and include it
