...
Computer vision allows you to make assertions about what's going on in images and video. It's fun to create image processing software, but it's not always *necessary* to implement such techniques yourself. Many of the most common and desirable computer vision workflows have been encapsulated into apps that can detect the stuff you want, and transmit the results over OSC. Before you dig in to this chapter, consider whether you can sketch a prototype with one of the time-saving tools listed here: 
