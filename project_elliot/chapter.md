...
* Kimchi and Chips **[BD: Link]**
* Mimi Son, Elliot Woods **[BD: Links]**
* Installation
* Seoul, 2013
* 4x3x7 meters (WxHxD)
...
The work contains a number of technical solutions, the principal one being an implementation of the Digital Emulsion technique. Others include a custom CAD application, generative 'brushes' for volumetric content, optical design of the room and equipment **[BD: What does this mean?]**, sound control and spatialisation and calibration by a team of client computers. This chapter touches on a few of these challenges.
...
###Structured Light
Structured Light refers to a set of techniques which couple projectors with sensors to take readings **[BD: What kind of readings?]** of the physical world.
...
The specific advantage of using Graycode (rather than 3-phase) structured light for Digital Emulsion projects, is that it gives you accurate information of the location of the __projector's pixels__ rather than of the __camera's pixels__. Folowing the Graycode scan, we can now consider that our projector's pixels are sensing the scene but are still also useable as pixels, that they in fact sensor-pixels~~, which we will shorten to sexels~~. **[BD: Elaborate a bit on what this means.]**
